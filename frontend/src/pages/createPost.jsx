    ...
    <section className='max-w-7xl max-auto'>
        <div>
            ...
            <p className='mt-2 text-[#66e75] text-[16px] max-w[500px]'>
                Create imaginative and visually stunning images throught DALLE -E AI 
            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-5'>
                    ...
                    type="text"
                    name="prompt"
                    placeholder={form.prompt ? form.prompt :  "an oil pastel drawing of an annoyed cat in a spaceship" }
                    value={form.prompt}
                    handleChange={handleChange} 
                    isSupriseMe
                    ...
                    <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue w-64 p-3 h-64 flex justify-center items-center'>
                        {form.photo ? (
                            ...
                            src={preview}
                            alt='preview'
                            className='w-9/12 h-9/9 object-contain opacity-40'
                            />
                        )}
                        {generatingImg && (
